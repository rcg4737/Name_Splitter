...
root.iconbitmap(r"\\rushmore.local\rlms-ca\LoanServicing\Acquisitions\Acquisitions\code_folder\titleRLMSgraphic - Copy (2).ico")
...
def automation():
    ...
    if os.path.splitext(name_file_path)[1]=='.xlsx':
        ...
        try:
            name_column = pd.read_excel(name_file_path, usecols=column_letter)
        except:
